...
//    virtual klee::ref<Expr> WPLoad(const klee::ref<Expr> &kid, const std::string name, Expr::Width w, uint64_t thread_id = -1) = 0;
//    virtual klee::ref<Expr> WPRegular(const std::string name, Expr::Width w, uint64_t = -1) = 0;
