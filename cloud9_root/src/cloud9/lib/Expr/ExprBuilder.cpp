...
class DefaultExprBuilder: public ExprBuilder {
	...
	virtual klee::ref<Expr> Read(const UpdateList &Updates, const klee::ref<Expr> &Index) {
		return ReadExpr::alloc(Updates, Index);
	}

	virtual klee::ref<Expr> Select(const klee::ref<Expr> &Cond, const klee::ref<Expr> &LHS, const klee::ref<Expr> &RHS) {
	...
	virtual klee::ref<Expr> Extract(const klee::ref<Expr> &LHS, unsigned Offset, Expr::Width W) {
...
public:
	...
	klee::ref<Expr> Read(const UpdateList &Updates, const klee::ref<Expr> &Index) {
		return Base->Read(Updates, Index);
	}

	klee::ref<Expr> Select(const klee::ref<Expr> &Cond, const klee::ref<Expr> &LHS, const klee::ref<Expr> &RHS) {
	...
	klee::ref<Expr> Extract(const klee::ref<Expr> &LHS, unsigned Offset, Expr::Width W) {
...
public:
	ConstantSpecializedExprBuilder(ExprBuilder *Base) :
			Builder(this, Base) {
	}
	...
	virtual klee::ref<Expr> WPLoad(const klee::ref<Expr> &kid, std::string name, Expr::Width w, uint64_t thread_id = -1) {
		return NULL;
	}

	virtual klee::ref<Expr> WPRegular(std::string name, Expr::Width w, uint64_t thread_id = -1) {
		return NULL;
	}
};
...
public:
	...
	klee::ref<Expr> Add(const klee::ref<ConstantExpr> &LHS, const klee::ref<NonConstantExpr> &RHS) {
		// 0 + X ==> X
		if (LHS->isZero())
			return RHS;
	...
	klee::ref<Expr> Add(const klee::ref<NonConstantExpr> &LHS, const klee::ref<ConstantExpr> &RHS) {
		return Add(RHS, LHS);
	}

	klee::ref<Expr> Add(const klee::ref<NonConstantExpr> &LHS, const klee::ref<NonConstantExpr> &RHS) {
		switch (LHS->getKind()) {
		default:
			break;
	...
	klee::ref<Expr> Sub(const klee::ref<ConstantExpr> &LHS, const klee::ref<NonConstantExpr> &RHS) {
		switch (RHS->getKind()) {
		default:
			break;
	...
	klee::ref<Expr> Sub(const klee::ref<NonConstantExpr> &LHS, const klee::ref<ConstantExpr> &RHS) {
		// X - C_0 ==> -C_0 + X
		return Add(RHS->Neg(), LHS);
	}

	klee::ref<Expr> Sub(const klee::ref<NonConstantExpr> &LHS, const klee::ref<NonConstantExpr> &RHS) {
		switch (LHS->getKind()) {
		default:
			break;
	...
	klee::ref<Expr> Mul(const klee::ref<ConstantExpr> &LHS, const klee::ref<NonConstantExpr> &RHS) {
		if (LHS->isZero())
			return LHS;
		if (LHS->isOne())
			return RHS;
	...
	klee::ref<Expr> Mul(const klee::ref<NonConstantExpr> &LHS, const klee::ref<ConstantExpr> &RHS) {
		return Mul(RHS, LHS);
	}

	klee::ref<Expr> Mul(const klee::ref<NonConstantExpr> &LHS, const klee::ref<NonConstantExpr> &RHS) {
		return Base->Mul(LHS, RHS);
	}

	klee::ref<Expr> And(const klee::ref<ConstantExpr> &LHS, const klee::ref<NonConstantExpr> &RHS) {
		if (LHS->isZero())
			return LHS;
		if (LHS->isAllOnes())
			return RHS;
	...
	klee::ref<Expr> And(const klee::ref<NonConstantExpr> &LHS, const klee::ref<ConstantExpr> &RHS) {
		return And(RHS, LHS);
	}

	klee::ref<Expr> And(const klee::ref<NonConstantExpr> &LHS, const klee::ref<NonConstantExpr> &RHS) {
		return Base->And(LHS, RHS);
	}

	klee::ref<Expr> Or(const klee::ref<ConstantExpr> &LHS, const klee::ref<NonConstantExpr> &RHS) {
		if (LHS->isZero())
			return RHS;
		if (LHS->isAllOnes())
			return LHS;
	...
	klee::ref<Expr> Or(const klee::ref<NonConstantExpr> &LHS, const klee::ref<ConstantExpr> &RHS) {
		return Or(RHS, LHS);
	}

	klee::ref<Expr> Or(const klee::ref<NonConstantExpr> &LHS, const klee::ref<NonConstantExpr> &RHS) {
		return Base->Or(LHS, RHS);
	}

	klee::ref<Expr> Xor(const klee::ref<ConstantExpr> &LHS, const klee::ref<NonConstantExpr> &RHS) {
		if (LHS->isZero())
			return RHS;
		// FIXME: Unbalance nested ors, fold constants through
		// {and,or}-with-constant, etc.
	...
	klee::ref<Expr> Xor(const klee::ref<NonConstantExpr> &LHS, const klee::ref<ConstantExpr> &RHS) {
		return Xor(RHS, LHS);
	}

	klee::ref<Expr> Xor(const klee::ref<NonConstantExpr> &LHS, const klee::ref<NonConstantExpr> &RHS) {
		return Base->Xor(LHS, RHS);
	}

	klee::ref<Expr> Eq(const klee::ref<ConstantExpr> &LHS, const klee::ref<NonConstantExpr> &RHS) {
	...
	klee::ref<Expr> Eq(const klee::ref<NonConstantExpr> &LHS, const klee::ref<ConstantExpr> &RHS) {
		return Eq(RHS, LHS);
	}

	klee::ref<Expr> Eq(const klee::ref<NonConstantExpr> &LHS, const klee::ref<NonConstantExpr> &RHS) {
		return Base->Eq(LHS, RHS);
	}
};
