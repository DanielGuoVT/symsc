...
StatisticManager::StatisticManager() :
		enabled(true), globalStats(0), totalIndices(0), indexedStats(0), changedIdxStats(0), contextStats(0), index(0) {
}
...
void StatisticManager::useIndexedStats(unsigned _totalIndices) {
	...
	memset(indexedStats, 0, sizeof(*indexedStats) * _totalIndices * stats.size());
