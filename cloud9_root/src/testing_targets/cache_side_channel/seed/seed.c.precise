...
static const byte ciphertext[BLOCK_SIZE] = {
...
seed_setkey ()
{
  static u32 x1, x2, x3, x4;
  static union wordbuf t0, t1;
  static u32 *keyout = ctx.keyschedule;
  static int i;
  static byte *in = key;
  ...
  x1 = ((u32)in[0] << 24) | ((u32)in[1] << 16) | \
         ((u32)in[2] << 8) | (u32)in[3];
  in = key + 4;
  x2 = ((u32)in[0] << 24) | ((u32)in[1] << 16) | \
         ((u32)in[2] << 8) | (u32)in[3];
  in = key + 8;
  x3 = ((u32)in[0] << 24) | ((u32)in[1] << 16) | \
         ((u32)in[2] << 8) | (u32)in[3];
  in = key + 12;
  x4 = ((u32)in[0] << 24) | ((u32)in[1] << 16) | \
         ((u32)in[2] << 8) | (u32)in[3];
