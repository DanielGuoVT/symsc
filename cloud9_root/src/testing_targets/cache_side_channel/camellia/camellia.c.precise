...
unsigned char in[BLOCK_SIZE] = { 0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, 0xfe, 0xdc, 0xba, 0x98, 0x76, 0x54, 0x32, 0x10 };
unsigned char out[BLOCK_SIZE] = { 0x67, 0x67, 0x31, 0x38, 0x54, 0x96, 0x69, 0x73, 0x08, 0x57, 0x06, 0x56, 0x48, 0xea, 0xbe, 0x43 };
...
static ulong64 F()
{
   ...
   D = SP1110[(x_input >> ((8-8)*8)) & 0xFF] ^ SP0222[(x_input >> ((8-5)*8)) & 0xFF] ^ SP3033[(x_input >> ((8-6)*8)) & 0xFF] ^ SP4404[(x_input >> ((8-7)*8)) & 0xFF];
   U = SP1110[(x_input >> ((8-1)*8)) & 0xFF] ^ SP0222[(x_input >> ((8-2)*8)) & 0xFF] ^ SP3033[(x_input >> ((8-3)*8)) & 0xFF] ^ SP4404[(x_input >> ((8-4)*8)) & 0xFF];
...
#define rot_128(in, count, out)\
    do{\
       (out)[0]=(in[(0+(count>>3))&15]<<(count&7))|(in[(0+(count>>3)+1)&15]>>(8-(count&7)));\
       (out)[1]=(in[(1+(count>>3))&15]<<(count&7))|(in[(1+(count>>3)+1)&15]>>(8-(count&7)));\
       (out)[2]=(in[(2+(count>>3))&15]<<(count&7))|(in[(2+(count>>3)+1)&15]>>(8-(count&7)));\
       (out)[3]=(in[(3+(count>>3))&15]<<(count&7))|(in[(3+(count>>3)+1)&15]>>(8-(count&7)));\
       (out)[4]=(in[(4+(count>>3))&15]<<(count&7))|(in[(4+(count>>3)+1)&15]>>(8-(count&7)));\
       (out)[5]=(in[(5+(count>>3))&15]<<(count&7))|(in[(5+(count>>3)+1)&15]>>(8-(count&7)));\
       (out)[6]=(in[(6+(count>>3))&15]<<(count&7))|(in[(6+(count>>3)+1)&15]>>(8-(count&7)));\
       (out)[7]=(in[(7+(count>>3))&15]<<(count&7))|(in[(7+(count>>3)+1)&15]>>(8-(count&7)));\
       (out)[8]=(in[(8+(count>>3))&15]<<(count&7))|(in[(8+(count>>3)+1)&15]>>(8-(count&7)));\
       (out)[9]=(in[(9+(count>>3))&15]<<(count&7))|(in[(9+(count>>3)+1)&15]>>(8-(count&7)));\
       (out)[10]=(in[(10+(count>>3))&15]<<(count&7))|(in[(10+(count>>3)+1)&15]>>(8-(count&7)));\
       (out)[11]=(in[(11+(count>>3))&15]<<(count&7))|(in[(11+(count>>3)+1)&15]>>(8-(count&7)));\
       (out)[12]=(in[(12+(count>>3))&15]<<(count&7))|(in[(12+(count>>3)+1)&15]>>(8-(count&7)));\
       (out)[13]=(in[(13+(count>>3))&15]<<(count&7))|(in[(13+(count>>3)+1)&15]>>(8-(count&7)));\
       (out)[14]=(in[(14+(count>>3))&15]<<(count&7))|(in[(14+(count>>3)+1)&15]>>(8-(count&7)));\
       (out)[15]=(in[(15+(count>>3))&15]<<(count&7))|(in[(15+(count>>3)+1)&15]>>(8-(count&7)));\
    }while(0)

int setup()
{
   static unsigned char T[48], kA[16], kB[16], kR[16], kL[16];
   static int           x;
   static ulong64       A, B;
   ...
   /* number of rounds */
   camellia.R = (KEY_SIZE == 16) ? 18 : 24;

   if (NUM_ROUNDS != 0 && NUM_ROUNDS != camellia.R) {
   ...
   LOAD64H(A, T+32); 
   LOAD64H(B, T+40);
   x_input = A ^ key_sigma[0];
   B ^= F();
   x_input = B ^ key_sigma[1];
   A ^= F();
   STORE64H(A, T+32); 
   STORE64H(B, T+40);
   ...
   LOAD64H(A, T+32);
   LOAD64H(B, T+40);
   x_input = A ^ key_sigma[2];
   B ^= F();
   x_input = B ^ key_sigma[3];
   A ^= F();
   STORE64H(A, T+32);
   STORE64H(B, T+40);
   ...
   if (KEY_SIZE == 16) {
      ...
      LOAD64H(camellia.kw[0], kL);
      LOAD64H(camellia.kw[1], kL+8);

      /* k1-k2 */
      LOAD64H(camellia.k[0], kA);
      LOAD64H(camellia.k[1], kA+8);

      /* rotate kL by 15, k3/k4 */
      rot_128(kL, 15, T+32);
      LOAD64H(camellia.k[2], T+32);
      LOAD64H(camellia.k[3], T+40);

      /* rotate kA by 15, k5/k6 */
      rot_128(kA, 15, T+32);
      LOAD64H(camellia.k[4], T+32);
      LOAD64H(camellia.k[5], T+40);

      /* rotate kA by 30, kl1, kl2 */
      rot_128(kA, 30, T+32);
      LOAD64H(camellia.kl[0], T+32);
      LOAD64H(camellia.kl[1], T+40);

      /* rotate kL by 45, k7/k8 */
      rot_128(kL, 45, T+32);
      LOAD64H(camellia.k[6], T+32);
      LOAD64H(camellia.k[7], T+40);

      /* rotate kA by 45, k9/k10 */
      rot_128(kA, 45, T+32);
      LOAD64H(camellia.k[8], T+32);
      rot_128(kL, 60, T+32);
      LOAD64H(camellia.k[9], T+40);

      /* rotate kA by 60, k11/k12 */
      rot_128(kA, 60, T+32);
      LOAD64H(camellia.k[10], T+32);
      LOAD64H(camellia.k[11], T+40);

      /* rotate kL by 77, kl3, kl4 */
      rot_128(kL, 77, T+32);
      LOAD64H(camellia.kl[2], T+32);
      LOAD64H(camellia.kl[3], T+40);

      /* rotate kL by 94, k13/k14 */
      rot_128(kL, 94, T+32);
      LOAD64H(camellia.k[12], T+32);
      LOAD64H(camellia.k[13], T+40);

      /* rotate kA by 94, k15/k16 */
      rot_128(kA, 94, T+32);
      LOAD64H(camellia.k[14], T+32);
      LOAD64H(camellia.k[15], T+40);

      /* rotate kL by 111, k17/k18 */
      rot_128(kL, 111, T+32);
      LOAD64H(camellia.k[16], T+32);
      LOAD64H(camellia.k[17], T+40);

      /* rotate kA by 111, kw3/kw4 */
      rot_128(kA, 111, T+32);
      LOAD64H(camellia.kw[2], T+32);
      LOAD64H(camellia.kw[3], T+40);
   } else {
      /* last two rounds */
      LOAD64H(A, T+32); 
      LOAD64H(B, T+40);
      x_input = A ^ key_sigma[4];
      B ^= F();
      x_input = B ^ key_sigma[5];  
      A ^= F();
      STORE64H(A, T+32); 
      STORE64H(B, T+40);
      ...
      /* k1/k2 = kB */
      LOAD64H(camellia.k[0], kB);
      LOAD64H(camellia.k[1], kB+8);
      ...
      /* kl5/6 = kA by 77  */
      rot_128(kA, 77, T+32);
      LOAD64H(camellia.kl[4], T+32);
      LOAD64H(camellia.kl[5], T+40);

      /* k19/k20 = kR by 94 */
      rot_128(kR, 94, T+32);
      LOAD64H(camellia.k[18], T+32);
      LOAD64H(camellia.k[19], T+40);

      /* k21/k22 = kA by 94 */
      rot_128(kA, 94, T+32);
      LOAD64H(camellia.k[20], T+32);
      LOAD64H(camellia.k[21], T+40);

      /* k23/k24 = kL by 111 */
      rot_128(kL, 111, T+32);
      LOAD64H(camellia.k[22], T+32);
      LOAD64H(camellia.k[23], T+40);
...
int encrypt()
{
   ...
   /* first 6 rounds */
   x_input = L ^ camellia.k[0];
   R ^= F();
   x_input = R ^ camellia.k[1];
   L ^= F();
   x_input = L ^ camellia.k[2];
   R ^= F();
   x_input = R ^ camellia.k[3];
   L ^= F();
   x_input = L ^ camellia.k[4];
   R ^= F();
   x_input = R ^ camellia.k[5];
   L ^= F();

   /* FL */
   a = (ulong32)(L >> 32);
   b = (ulong32)(L & 0xFFFFFFFFUL);
   b ^= ROL((a & (ulong32)(camellia.kl[0] >> 32)), 1);
   a ^= b | (camellia.kl[0] & 0xFFFFFFFFU);
   L = (((ulong64)a) << 32) | b;

   /* FL^-1 */
   a = (ulong32)(R >> 32);
   b = (ulong32)(R & 0xFFFFFFFFUL);
   a ^= b | (camellia.kl[1] & 0xFFFFFFFFU);
   b ^= ROL((a & (ulong32)(camellia.kl[1] >> 32)), 1);
   R = (((ulong64)a) << 32) | b;

   /* second 6 rounds */
   x_input = L ^ camellia.k[6];
   R ^= F();
   x_input = R ^ camellia.k[7];
   L ^= F();
   x_input = L ^ camellia.k[8];
   R ^= F();
   x_input = R ^ camellia.k[9];
   L ^= F();
   x_input = L ^ camellia.k[10];
   R ^= F();
   x_input = R ^ camellia.k[11];
   L ^= F();

   /* FL */
   a = (ulong32)(L >> 32);
   b = (ulong32)(L & 0xFFFFFFFFUL);
   b ^= ROL((a & (ulong32)(camellia.kl[2] >> 32)), 1);
   a ^= b | (camellia.kl[2] & 0xFFFFFFFFU);
   L = (((ulong64)a) << 32) | b;

   /* FL^-1 */
   a = (ulong32)(R >> 32);
   b = (ulong32)(R & 0xFFFFFFFFUL);
   a ^= b | (camellia.kl[3] & 0xFFFFFFFFU);
   b ^= ROL((a & (ulong32)(camellia.kl[3] >> 32)), 1);
   R = (((ulong64)a) << 32) | b;

   /* third 6 rounds */
   x_input = L ^ camellia.k[12];
   R ^= F();
   x_input = R ^ camellia.k[13];
   L ^= F();
   x_input = L ^ camellia.k[14];
   R ^= F();
   x_input = R ^ camellia.k[15];
   L ^= F();
   x_input = L ^ camellia.k[16];
   R ^= F();
   x_input = R ^ camellia.k[17];
   L ^= F();
   ...
   if (camellia.R == 24) {
      ...
      a = (ulong32)(L >> 32);
      b = (ulong32)(L & 0xFFFFFFFFUL);
      b ^= ROL((a & (ulong32)(camellia.kl[4] >> 32)), 1);
      a ^= b | (camellia.kl[4] & 0xFFFFFFFFU);
      L = (((ulong64)a) << 32) | b;

      /* FL^-1 */
      a = (ulong32)(R >> 32);
      b = (ulong32)(R & 0xFFFFFFFFUL);
      a ^= b | (camellia.kl[5] & 0xFFFFFFFFU);
      b ^= ROL((a & (ulong32)(camellia.kl[5] >> 32)), 1);
      R = (((ulong64)a) << 32) | b;

      /* fourth 6 rounds */
      x_input = L ^ camellia.k[18];
      R ^= F();
      x_input = R ^ camellia.k[19];
      L ^= F();
      x_input = L ^ camellia.k[20];
      R ^= F();
      x_input = R ^ camellia.k[21];
      L ^= F();
      x_input = L ^ camellia.k[22];
      R ^= F();
      x_input = R ^ camellia.k[23];
      L ^= F();
   }
...
#define shadow
#ifdef shadow
unsigned char key_shadow[KEY_SIZE] = { 0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, 0xfe, 0xdc, 0xba, 0x98, 0x76, 0x54, 0x32, 0x10 };
int setup1()
{
   static unsigned char T[48], kA[16], kB[16], kR[16], kL[16];
   static int           x;
