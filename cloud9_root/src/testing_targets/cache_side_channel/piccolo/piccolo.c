...
uint8_t block[16] = {32,121,77,42,124,37,91,88,97,39,101,41,23,66,89,115};
uint8_t in_key[12] = {0};
uint8_t roundKeys[108] = {0};

uint8_t in_key_shadow[12] = {0};
...
int main(void)
{
  ...
  #define shadow
  #ifdef shadow
  klee_make_symbolic(in_key_shadow, sizeof(in_key_shadow), "key_shadow");
  klee_task_boundary();
  RunEncryptionKeySchedule();
  Piccolo_encrypt();
  #endif 
